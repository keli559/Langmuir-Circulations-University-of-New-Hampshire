...
for jj=1:M
    vnew(:,jj)=xi*chedfft(Psinew(:,jj));
      ...
      subplot(1, 3, 1),imagesc(Y,Z,unew), title('x-velocity'),colorbar,
      subplot(1, 3, 2),imagesc(Y,Z,Omeganew),title('x-vorticity'),colorbar,
      subplot(1, 3, 3),imagesc(Y,Z,Psinew),title('streamfunction'),colorbar,
if mod(kk, 1)==0
